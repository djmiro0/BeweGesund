...
> = {
  reha: {
    ...
    image:
      "https://images.unsplash.com/photo-1519823551278-64ac92734fb1?auto=format&fit=crop&q=82&w=1200",
    pillLimit: 3,
  },
  "healthy-living": {
    accent: "#b5d83d",
  ...
  overweight: {
    ...
    image:
      "https://images.unsplash.com/photo-1549576490-b0b4831ef60a?auto=format&fit=crop&q=82&w=1200",
    pillLimit: 2,
  },
  intensive: {
    accent: "#ff6b1a",
    ...
    image:
      "https://images.unsplash.com/photo-1605296867304-46d5465a13f1?auto=format&fit=crop&q=82&w=1200",
    pillLimit: 2,
  },
  "pre-post-birth": {
    accent: "#f25aa5",
    ...
    image:
      "https://images.unsplash.com/photo-1537673156864-5d2c72de7824?auto=format&fit=crop&q=82&w=1200",
    pillLimit: 2,
  },
  "corporate-fitness": {
    accent: "#8b5cf6",
    ...
    image:
      "https://images.unsplash.com/photo-1518611012118-696072aa579a?auto=format&fit=crop&q=82&w=1200",
    pillLimit: 2,
  },
  "live-courses": {
    accent: "#38bdf8",
  ...
  "live-seminars": {
    ...
    image:
      "https://images.unsplash.com/photo-1516321318423-f06f85e504b3?auto=format&fit=crop&q=82&w=1200",
    pillLimit: 2,
  },
  "nutrition-seminars": {
    accent: "#22c55e",
    ...
    image:
      "https://images.unsplash.com/photo-1490818387583-1baba5e638af?auto=format&fit=crop&q=82&w=1200",
    pillLimit: 2,
  },
};
...
export default function CoursesClient({
  ...
  const visibleGroups = groupedCourses.filter((group) => {
    const hasSubtypes = memberCourses.some(
      (course) => canonicalCategory(course.categoryKey) === group.id,
    );
    return (
  ...
  return (
    <section className={`${styles.coursesSection} ${styles.overviewSection}`}>
      ...
      >
        ...
        <motion.aside
          className={`${styles.unlockPanel} ${styles.overviewAccess}`}
          variants={fadeUp}
        >
      ...
      >
        {visibleGroups.map((group) => {
          ...
          const hiddenPillCount = Math.max(
            0,
            pillItems.length - visiblePillItems.length,
          );
          const categoryStyle = {
                  ...
                  <div className={styles.categoryHead}>
                    ...
                    <div>
                      <h2 className={styles.categoryTitle}>
                        {t(`courseTypes.categories.${group.id}.title`)}
                      </h2>
                    </div>
                  </div>
