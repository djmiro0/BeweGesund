...
export default async function ImpressumPage({
  ...
  const sections = isGerman
    ? [
        ...
        {
          title: "Vertretung und inhaltliche Verantwortung",
          body: provider.responsiblePerson,
        },
        { title: "Kontakt", body: contact },
        ...(provider.vatId
          ? [{ title: "Umsatzsteuer-ID", body: provider.vatId }]
          : []),
        {
    ...
    : [
        {
          title: "Provider information under § 5 DDG",
          body: `${provider.name}\n${provider.address}`,
        },
        {
          title: "Representation and content responsibility",
          body: provider.responsiblePerson,
        },
        { title: "Contact", body: contact },
        ...(provider.vatId
          ? [{ title: "VAT identification number", body: provider.vatId }]
          : []),
        {
  ...
  return (
    <InfoPage
      ...
      intro={
        isGerman
          ? "Anbieterkennzeichnung für Bewegesund."
          : "Legal provider information for Bewegesund."
      }
      sections={sections}
