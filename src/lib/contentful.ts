...
function canonicalMeditationRelaxationSubcategory(value: unknown) {
  ...
  const aliases: Record<string, string> = {
    ...
    "samomassage-in-cilju-redukcije-stresa": "self-massage-stress-reduction",
    "samomassage-zur-stressreduktion": "self-massage-stress-reduction",
    "selbstmassage-zur-stressreduktion": "self-massage-stress-reduction",
    "self-massage-stress-reduction": "self-massage-stress-reduction",
    "self-massage-for-stress-reduction": "self-massage-stress-reduction",
