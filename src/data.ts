...
export const memberCourses: MemberCourseDefinition[] = [
  ...
  {
    id: "full-body-strength-advanced",
    categoryKey: "definition",
    durationMinutes: 25,
    unlocksPerWeek: 1,
    plannedTrainingCount: 20,
...
export const memberCourseCategories: MemberCourseCategory[] = [
  ...
  },
  {
    ...
    courseIds: [
      "abs-intensive",
      "glutes-intensive",
      "full-body-strength-advanced",
    ],
  },
  {
    id: "pre-post-birth",
    courseIds: ["pelvic-floor", "birth-preparation", "baby-training"],
  },
